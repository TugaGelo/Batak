          ...
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                ...
                border: Border(bottom: BorderSide(color: Color(0xFF353535))),
              ),
              child: Row(
                ...
                children: [
                      ...
                      child: Row(
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              Text(entry.value.name, style: const TextStyle(color: Color(0xFFFEF8E5), fontSize: 14, fontWeight: FontWeight.w600)),
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(6),
                        border: Border.all(color: const Color(0xFF353535)), // Mimicking the dashed look cleanly
                      ),
                      child: const Row(
