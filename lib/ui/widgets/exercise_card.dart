      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  Text(exercise.name, style: const TextStyle(color: Color(0xFFFEF8E5), fontSize: 22, fontWeight: FontWeight.bold)),
                ],
              ),
          ...
          ...exSession.sets.asMap().entries.map((entry) {
            return SetLogRow(exerciseIndex: exerciseIndex, setIndex: entry.key, activeSet: entry.value);
          }),
          ...
          Row(
            ...
            children: [
              ...
              OutlinedButton.icon(
                onPressed: () => _openAiSwapper(context, ref, exercise.id.toString()), 
