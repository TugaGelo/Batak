...
import '../routine/dialogs/exercise_sheet_row.dart';
import '../routine/dialogs/ai_swapper_sheet.dart';
...
class ExerciseCard extends ConsumerWidget {
  ...
  void _openAiSwapper(BuildContext context, int index, dynamic exercise) {
    showModalBottomSheet(
      context: context,
      isScrollControlled: true,
      backgroundColor: Colors.transparent,
      builder: (context) => AiSwapperSheet(
        exerciseIndex: index,
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              OutlinedButton.icon(
                onPressed: () => _openAiSwapper(context, exerciseIndex, exercise),
